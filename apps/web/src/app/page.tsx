    ...
    <main className="min-h-screen bg-[#1a1410] relative overflow-hidden">
      ...
      <div className="hidden lg:block fixed left-5 top-0 bottom-0 z-0 pointer-events-none select-none overflow-hidden"
        ...
        <div className="animate-scroll-calligraphy whitespace-nowrap pt-8"
          style={{ writingMode: 'vertical-rl', color: 'rgba(194,59,34,0.12)', fontSize: 13, lineHeight: 2, fontFamily: "'KaiTi','STKaiti','Noto Serif SC',serif" }}>
...
function ControlPanel({
  ...
  return (
    <div className="rounded-xl p-3 bg-[#2a1e1b]/50 backdrop-blur-md border border-[#c9a84c]/8 space-y-2.5">
...
function FenInput({ fen, onFenChange }: { fen: string; onFenChange: (v: string) => void }) {
  return (
    <div className="rounded-xl bg-[#1a1410]/60 border border-[#c9a84c]/8 overflow-hidden">
      ...
      {scenes.map((s) => (
        <button key={s.label} onClick={() => onSelect(s.fen)}
          className="px-2.5 py-1 text-[10px] font-['KaiTi','STKaiti',serif] tracking-wider
            bg-[#2a1e1b]/30 border border-[#c9a84c]/8 text-[#c9a84c]/35
